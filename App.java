...
public class App {
	...
	public static void main(String[] args) {
		// TODO Auto-generated method stub
	        ...
	        Question [] questions1 ={
	        		...
	        		new Question(bq3,"b"),//this correspond to the first prompt
	        		new Question(bq4,"b"),//this correspond to the first prompt
	        		new Question(bq5,"a")//this correspond to the first prompt
	        ...
	        Question [] questions2 ={
	        		...
	        		new Question(iq3,"d"),//this correspond to the first prompt
	        		new Question(iq4,"a"),//this correspond to the first prompt
	        		new Question(iq5,"c")//this correspond to the first prompt
	};if(option==2){
    ...
    Question [] questions3 ={
    		...
    		new Question(aq3,"d"),//this correspond to the first prompt
    		new Question(aq4,"a"),//this correspond to the first prompt
    		new Question(aq5,"b")//this correspond to the first prompt
};if(option==3){
...
Advanced(questions3);
	...
	public static void Beginner(Question [] questions1)//creating a method and passing array of questions that is created
	{
		...
		System.out.println ("You got"+ correctAnsCount+"/"+ questions1.length);//from the possible questions the score will be 
	...
	public static void medium(Question [] questions2)//creating a method and passing array of questions that is created
	{
        ...
        System.out.println("Correct Answered Questions : "+correctAnsCount);
        System.out.println("Wrong Answered Questions : "+wrongAnsCount);
		System.out.println ("You got"+ correctAnsCount+"/"+ questions2.length);//from the possible questions the score will be 
	...
	public static void Advanced(Question [] questions3)//creating a method and passing array of questions that is created
	{
        ...
        System.out.println("Correct Answered Questions : "+correctAnsCount);
        System.out.println("Wrong Answered Questions : "+wrongAnsCount);
		System.out.println ("You got"+ correctAnsCount+"/"+ questions3.length);//from the possible questions the score will be 
